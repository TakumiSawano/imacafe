...
<form method="post">
	<h1>今カフェ会員登録</h1>
  <p>本サイト「今？カフェで作業中。」はビジネスマン達によって作り上げる、<br>
    ビジネスマン達のための相互勉強サイトです。それ以外の目的の方のご利用はお断りしております。</p>
  <p>
  <div class="error">
  <?php echo $error; ?><br>
  <?php
  ...
  <p>
	...
	<button type="submit" class="btn btn-default" name="signup">無料登録</button><br>
	<a href="imacafe_login.php">今カフェ会員の方はこちら</a>
</form>
</article>
</body>
</html>
